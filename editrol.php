...
<div class="text-center">
    <h1><i class="fas fa-user-tie"></i> EDICIÓN DEL ROL</h1>
    <br>
    <div class="row form-padding">
        <div class="col-md-12">Sesión actual:<br><b>ADMIN</b></div>
        <!-- <div class="col-md-2"><a class="btn-block btn-material" href="admincreate.php"><i class="fas fa-reply"></i> ATRÁS</a></div> -->
    </div>
    <section>
        <div class="form-group form-padding row form-top-border d-flex justify-content-center">
            <form action="#" method="post">
                <div class="col-xs-3">
                    <input type="text" class="form-control" id="cod_rol" placeholder="ID_ROL" readonly>
                </div>
                <br>
                <div class="col-xs-3">
                    <input type="text" class="form-control" id="name_rol" placeholder="Nombre del Rol">
                </div>
                <br>
