...
<div class="text-center">
    ...
    <div class="row form-padding form-top-border">
        ...
        <div class="col-sm-1">
            <a class="btn btn-outline-success btn-sm" href="#"><i class="fas fa-eye" style="font-size:24px"></i></a>
        </div>
        <div class="col-sm-1">
            <a class="btn btn-outline-info btn-sm" href="adminedit.php?user=USERNAME"><i class="fas fa-user-edit" style="font-size:24px"></i></a>
        </div>
        <div id="deldiv_USERNAME" name="deldiv_USERNAME" class="col-sm-1">
            <a class="btn btn-outline-warning btn-sm" href="javascript:;" onclick="showDiv_USERNAME()"><i class="fas fa-user-slash" style="font-size:24px"></i></a>
        </div>
