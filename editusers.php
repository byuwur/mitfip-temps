    ...
    <form method="POST" action="">
        <div class="row form-padding form-top-border">
            <div class="group col-12 col-sm-6 col-md-4">
                <input type="text" disabled value="ID" /><span class="highlight"></span><span class="bar"></span><label>Cédula</label>
            </div>
            <div class="group col-12 col-sm-6 col-md-4">
                <input type="text" disabled value="USERNAME" /><span class="highlight"></span><span class="bar"></span><label>Usuario</label>
            </div>
            <div class="group col-12 col-sm-6 col-md-4">
                <input type="text" id="nombre" name="nombre" value="NOMBRE" required /><span class="highlight"></span><span class="bar"></span><label>Nombre completo</label>
            </div>
            <div class="group col-12 col-sm-6 col-md-4">
